...
contract CouncilERC20 is ERC20, ERC20Votes, Ownable {
  ...
  /// @notice The maximum number of tokens that an member can hold
  ...
  /// @param _maxTokensPerMember The maximum number of tokens that an member can hold
  constructor(
    string memory _name,
  ...
  /// @notice Update the token balances and voting units
  /// @param _from The address to update the balances from
